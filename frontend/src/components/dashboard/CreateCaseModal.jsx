                ...
                <form className="p-6 flex flex-col gap-4 text-xs" onSubmit={onSubmit}>
                    ...
                    <div className="form-group flex flex-col gap-1.5">
                        ...
                        <input 
                            ...
                            required 
                            value={newCaseDocket}
                            onChange={e => setNewCaseDocket(e.target.value)}
                    ...
                    <div className="modal-actions flex justify-end gap-3 mt-4 pt-4 border-t border-[#e8e3d5]">
                        ...
                        <button type="submit" className="btn btn-gold bg-[#2a1b12] text-[#dfb86c] border border-[#c5a059] px-4 py-2 hover:bg-[#3d2a1d] hover:text-white rounded font-semibold text-xs cursor-pointer">Initialize File</button>
                    </div>
                </form>
            </div>
        </div>
